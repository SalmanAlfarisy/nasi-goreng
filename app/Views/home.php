...
<body class="bg-zinc-100">
    <main class="max-w-4xl w-full mx-auto bg-white">
        <header class="flex items-center justify-between bg-sky-500 py-3 px-8 rounded shadow mt-9">
            <a href="<?= base_url() ?>">
                    ...
                    <div class="px-3 py-2">
                        ...
                        <form action="<?= base_url() ?>" method="post">
                            ...
                            <div class="flex items-center justify-between -mt-4">
                                ...
                                <button type="submit"
                                    class="px-3 py-2 bg-sky-500 text-white text-sm uppercase rounded hover:bg-sky-300">Tambah</button>
                            </div>
                        </form>
                    </div>
                </div>
