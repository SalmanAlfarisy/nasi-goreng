...
<body class="bg-zinc-100">
    <main class="max-w-4xl w-full mx-auto bg-white min-h-screen">
        <header class="flex items-center justify-between bg-sky-500 py-3 px-8 rounded shadow mt-3">
            <a href="<?= base_url() ?>">
                <h1 class="font-bold text-2xl text-white">Nasi Goreng Berkah Jaya</h1>
            </a>
        ...
        <div class="w-full overflow-x-auto p-3">
            ...
            <div class="flex items-center justify-end mt-3">
                <button id="bayar" class="uppercase px-5 py-2 rounded bg-emerald-500 text-white bg-sky-500 hover:bg-sky-300">Bayar</button>
            </div>
        </div>
    </main>
    <!-- transaksi dialog -->
    <div class="absolute top-0 left-0 w-full h-screen bg-zinc-900 bg-opacity-50 flex items-center justify-center invisible"
        ...
        <div class="w-full max-w-lg h-96 bg-white rounded p-5 relative">
            ...
            <div class="px-3 py-2">
                ...
                <button type="submit"
                    class="uppercase text-white bg-sky-500 flex-1 w-full px-3 py-2 font-semibold rounded mt-3 hover:bg-sky-300 cursor-pointer">
                    bayar
                </button>
            </div>
        </div>
