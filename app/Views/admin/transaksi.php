...
<body>
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 h-screen overscroll-y-auto p-3">
            <header class="sticky top-0 z-50 w-full shadow-md rounded-md transition-all flex-1 h-72 overflow-clip" 
            id="indexHeader" style="background-image: url('<?= base_url("image/bgTransaksi.jpg") ?>'); 
