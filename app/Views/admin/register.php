        ...
        <div class="flex items-center w-full h-[450px] max-w-md rounded-2xl shadow-md overflow-clip bg-white">
            <div class="flex-1 h-full flex flex-col justify-center max-w-xs mx-auto">
                <div class="w-full flex justify-center">
                    <h1 class="font-bold text-2xl text-zinc-950 mb-5 pb-2">Silahkan Daftar</h1>
                </div>
                <form action="<?= base_url("register") ?>" method="post">
                    ...
                    <button type="submit"
                        class="uppercase font-medium w-full p-3 mt-3 bg-sky-500 hover:bg-sky-300 text-white rounded-full shadow-md">Daftar</button>
                </form>
            </div>
        </div>
    </div>
